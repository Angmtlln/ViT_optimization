...
EXPERIMENTS = [
    ...
    {
        'name': 'feature_baseline_no_distill',
        'temperature': 1.0,
...
def run_experiment(exp_config, train_loader, val_loader, test_loader,
    ...
    results = {
        ...
        'avg_mse_distance': float(avg_mse),
    ...
    # Сохранение
    results_dir = Path('../results/feature_distillation')
...
def main():
    ...
    print('='*80)
    print(f'\nРезультаты сохранены в: ../results/feature_distillation/')
