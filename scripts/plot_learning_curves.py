...
def load_results(results_dir='../results/logit_s'):
...
def plot_main_learning_curve(results, save_path='../plots/distillation_logit_s/learning_curve_main.png'):
    """
...
def plot_temperature_comparison(results, save_path='../plots/distillation_logit_s/temperature_effect.png'):
    """
...
def plot_alpha_comparison(results, save_path='../plots/distillation_logit_s/alpha_effect.png'):
    """
...
def plot_loss_curves(results, save_path='../plots/distillation_logit_s/loss_curves.png'):
    """
...
def plot_summary_table(results, save_path='../plots/distillation_logit_s/summary_table.png'):
    """
...
def main():
    ...
    results = load_results('../results/logit_s')
    
    if not results:
        print('❌ Результаты не найдены в ../results/logit_s!')
        return
    
    print('📊 Построение графиков...\n')
    
    # 1. Основной график - Learning Curves
    plot_main_learning_curve(results, save_path='../plots/distillation_logit_s/learning_curve_main.png')
    
    # 2. Влияние температуры
    plot_temperature_comparison(results,save_path='../plots/distillation_logit_s/temperature_effect.png')
    
    # 3. Влияние alpha
    plot_alpha_comparison(results, save_path='../plots/distillation_logit_s/alpha_effect.png')
    
    # 4. Loss curves
    plot_loss_curves(results, save_path='../plots/distillation_logit_s/loss_curves.png')
    
    # 5. Таблица результатов
    plot_summary_table(results, save_path='../plots/distillation_logit_s/summary_table.png')
    ...
    print('='*80)
    print(f'📁 Графики сохранены в: ../results/logit_s/')
    print('\nСозданные файлы:')
